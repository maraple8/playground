...
@MapperScan("com.xfhuang.playground.count.biz.domain.mapper")
public class playgroundCountBizApplication {

    public static void main(String[] args) {
        SpringApplication.run(playgroundCountBizApplication.class, args);
