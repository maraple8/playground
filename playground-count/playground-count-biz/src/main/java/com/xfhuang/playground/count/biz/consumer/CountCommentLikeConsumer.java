...
import com.xfhuang.playground.count.biz.enums.LikeUnlikeCommentTypeEnum;
import com.xfhuang.playground.count.biz.model.dto.AggregationCountLikeUnlikeCommentMqDTO;
import com.xfhuang.playground.count.biz.model.dto.CountLikeUnlikeCommentMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "playground_group_count_" + MQConstants.TOPIC_COMMENT_LIKE_OR_UNLIKE, // Group 组
