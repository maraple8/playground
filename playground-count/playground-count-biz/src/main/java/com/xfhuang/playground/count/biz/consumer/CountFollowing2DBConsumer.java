...
import com.xfhuang.playground.count.biz.enums.FollowUnfollowTypeEnum;
import com.xfhuang.playground.count.biz.model.dto.CountFollowUnfollowMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "playground_group_" + MQConstants.TOPIC_COUNT_FOLLOWING_2_DB, // Group 组
