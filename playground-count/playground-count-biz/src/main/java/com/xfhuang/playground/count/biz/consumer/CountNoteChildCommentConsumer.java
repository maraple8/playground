...
import com.xfhuang.playground.count.biz.domain.mapper.CommentDOMapper;
import com.xfhuang.playground.count.biz.enums.CommentLevelEnum;
import com.xfhuang.playground.count.biz.model.dto.CountPublishCommentMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "playground_group_child_comment_total" + MQConstants.TOPIC_COUNT_NOTE_COMMENT, // Group 组
