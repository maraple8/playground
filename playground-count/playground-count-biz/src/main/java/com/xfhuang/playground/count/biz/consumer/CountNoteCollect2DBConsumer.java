...
import com.xfhuang.playground.count.biz.domain.mapper.NoteCountDOMapper;
import com.xfhuang.playground.count.biz.domain.mapper.UserCountDOMapper;
...
@Component
@RocketMQMessageListener(consumerGroup = "playground_group_" + MQConstants.TOPIC_COUNT_NOTE_COLLECT_2_DB, // Group 组
