...
import com.xfhuang.playground.count.biz.enums.LikeUnlikeNoteTypeEnum;
import com.xfhuang.playground.count.biz.model.dto.AggregationCountLikeUnlikeNoteMqDTO;
import com.xfhuang.playground.count.biz.model.dto.CountLikeUnlikeNoteMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "playground_group_" + MQConstants.TOPIC_COUNT_NOTE_LIKE, // Group 组
