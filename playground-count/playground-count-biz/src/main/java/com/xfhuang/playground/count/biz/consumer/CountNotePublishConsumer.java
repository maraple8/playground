...
import com.xfhuang.playground.count.biz.model.dto.NoteOperateMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "playground_group_" + MQConstants.TOPIC_NOTE_OPERATE, // Group 组
