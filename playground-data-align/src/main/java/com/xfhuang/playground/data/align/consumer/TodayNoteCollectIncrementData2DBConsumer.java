package com.xfhuang.playground.data.align.consumer;

import com.xfhuang.framework.common.util.JsonUtils;
import com.xfhuang.playground.data.align.constant.MQConstants;
import com.xfhuang.playground.data.align.constant.RedisKeyConstants;
import com.xfhuang.playground.data.align.constant.TableConstants;
import com.xfhuang.playground.data.align.domain.mapper.InsertMapper;
import com.xfhuang.playground.data.align.model.dto.CollectUnCollectNoteMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "playground_group_data_align_" + MQConstants.TOPIC_COUNT_NOTE_COLLECT, // Group 组
