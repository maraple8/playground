...
import com.xfhuang.playground.data.align.model.dto.NoteOperateMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "playground_group_data_align_" + MQConstants.TOPIC_NOTE_OPERATE, // Group 组
