package com.xfhuang.playground.user.relation.biz.consumer;
...
import com.xfhuang.playground.user.relation.biz.enums.FollowUnfollowTypeEnum;
import com.xfhuang.playground.user.relation.biz.model.dto.CountFollowUnfollowMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "playground_group_" + MQConstants.TOPIC_FOLLOW_OR_UNFOLLOW, // Group 组
