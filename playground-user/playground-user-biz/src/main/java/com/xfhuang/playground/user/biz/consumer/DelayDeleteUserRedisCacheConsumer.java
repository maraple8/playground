package com.xfhuang.playground.user.biz.consumer;
...
@Component
@Slf4j
@RocketMQMessageListener(consumerGroup = "playground_group_" + MQConstants.TOPIC_DELAY_DELETE_USER_REDIS_CACHE, // Group
