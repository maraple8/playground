package com.xfhuang.playground.user.biz.enums;

import com.xfhuang.framework.common.exception.BaseExceptionInterface;
...
public enum ResponseCodeEnum implements BaseExceptionInterface {
    ...
    playground_ID_VALID_FAIL("USER-20002", "玩乐圈号请设置6-15个字符，仅可使用英文（必须）、数字、下划线"),
